module.exports = {
  ...
  PRODUCTS_CANNOT_BE_REMOVED_AFTER_DELIVERY: 'Products can not be removed after order has been delivered.',
  ...
  FILE_IS_MISSING: 'file is not found in request',
  DATABASE_ERROR: 'data is not stored in database',
  DATA_NOT_FOUND: 'data not found',
  DEVICE_MAC_ALREADY_EXISTS: 'Device mac address already exists',
